...
A from-scratch C implementation of [VADER](https://github.com/cjhutto/vaderSentiment)
(Valence Aware Dictionary and sEntiment Reasoner) — a lexicon- and rule-based sentiment
analysis method. Rather than calling an existing sentiment analysis library, this
parses VADER's lexicon directly and re-implements its scoring rules: intensifiers
